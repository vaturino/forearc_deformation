...
file_path = 'sam_geometry_with_litho.nc';
...
disp(['Lithosphere range: ', num2str(min(lith1(:))), ' to ', num2str(max(lith1(:)))]);


vtkwrite('paraview_inputs/sam_with_lith.vtk', ...
    'structured_grid', x*1000, y*1000, z*1000, ...
    'scalars', 'temperature', temp1, ...
    'scalars', 'slab_geometry', slabs1, ...
    'scalars', 'crust_geometry', comp1, ...
    'scalars', 'lithosphere_geometry', lith1, ...
    'binary');
